                ...
                <div class="row g-3">
                            ...
                            <form action="/reviews/add" method="post" class="m-3 w-100">
                                ...
                                <?php if ($session->has('rating')) { ?>
                                    <div id="name" class="invalid-feedback">
                                        <?php echo $session->getFlash('rating') ?>
                                    </div>
                                <?php } ?>
                                <div class="form-floating mt-2">
                                    ...
                                    <?php if ($session->has('comment')) { ?>
                                        <div id="name" class="invalid-feedback">
                                            <?php echo $session->getFlash('comment') ?>
                                        </div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Оценка <span class="badge bg-warning warn__badge"></span> <?php echo $movie->avgRating()?> </span></p>
