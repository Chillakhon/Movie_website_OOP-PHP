                        ...
                        <div class="form-floating">
                            ...
                            <?php if ($session->has('name')) { ?>
                                <div id="name" class="invalid-feedback">
                                    <?php echo $session->getFlash('name') ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div class="row g-2">
                        ...
                        <div class="form-floating">
                            ...
                            <?php if ($session->has('password')) { ?>
                                <div id="password" class="invalid-feedback">
                                    <?php echo $session->getFlash('password') ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-md">
                        <div class="form-floating">
                            <input
                                    type="password"
                                   class="form-control <?php echo $session->has('password_confirmation') ? 'is-invalid' : '' ?>"
                            ...
                            <?php if ($session->has('password_confirmation')) { ?>
                                <div id="password" class="invalid-feedback">
                                    <?php echo $session->getFlash('password_confirmation') ?>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
